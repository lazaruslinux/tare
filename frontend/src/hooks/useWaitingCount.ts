...
// How many submissions are waiting, read once for the three places that say
// so: the More tab, the rail's More row, and the row that opens the queue.
// Nobody but an administrator has the route, so nobody else asks. Null is
