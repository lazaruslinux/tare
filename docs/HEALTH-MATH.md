...
13. Weight loss rate is set with a stepper, and all three steps are offered to every member:
   ...
   The screen works every step out as if it were chosen (the cap of decision 14 and the floor of decision 15 applied to each) and shows each step's own budget, what it asked for, and where the cap or floor held it, with a sentence per step. Two steps held to the same budget therefore say why instead of reading alike. (His call of 2026-09-06.)
